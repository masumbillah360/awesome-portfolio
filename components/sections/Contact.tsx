    ...
    <section className="py-10  sm:py-16 lg:py-24" id="contact">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold leading-tight text-primary dark:text-primary-foreground sm:text-4xl lg:text-5xl">
            Contact Me
          </h2>
          <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">
            Feel free to contact with me using any medium. I have shared my all
