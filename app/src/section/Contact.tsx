                ...
                <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
                    <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                <svg className="flex-shrink-0 w-10 h-10 mx-auto text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path
                                        strokeLinecap="round"
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900">+880 1783980102</p>
                                <p className="mt-1 text-lg font-medium text-gray-900">+880 1949211772</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900">masumbillah6584@gmail.com</p>
                                <p className="mt-1 text-lg font-medium text-gray-900">dev.billah@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">Mymensingh, Dhaka, <span className='font-bold'>Bangladesh</span></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="#" method="POST" className="mt-14">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="mt-2.5 relative">
                                            <textarea name="" id="" placeholder="" className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md resize-y focus:outline-none focus:border-blue-600 caret-blue-600" rows={4} />
                                        </div>
                                    </div>
